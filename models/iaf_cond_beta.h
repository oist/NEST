...
namespace nest
{
   ...
   */
  extern "C"
  int iaf_cond_beta_dynamics (double, const double*, double*, void*);
  ...
  private:
    ...
    struct Parameters_ {
      ...
      double_t tau_synE1;    //!< Synaptic Time Constant Excitatory Synapse in ms
      double_t tau_synE2;    //!< Synaptic Time Constant Excitatory Synapse in ms
      double_t tau_synI1;    //!< Synaptic Time Constant for Inhibitory Synapse in ms
      double_t tau_synI2;    //!< Synaptic Time Constant for Inhibitory Synapse in ms
  ...
  inline
  void iaf_cond_beta::get_status(DictionaryDatum &d) const
  {
    P_.get(d);
    S_.get(d);
  ...
  inline
  void iaf_cond_beta::set_status(const DictionaryDatum &d)
  {
